...
const IndexPage = ({
  ...
  <html lang='en'>
    <head>
      ...
      <meta property='og:title' content="Resumé | Alex Birdsall :: Software Engineer" />
      <meta property='og:description' content={description} />
      <meta property='og:type' content='website' />
      <link rel="icon" href={`./favicon-32x32.png?v=${sha}`} type="image/png"/>
      <link rel="apple-touch-icon" sizes="48x48"   href={`./icons/icon-48x48.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="72x72"   href={`./icons/icon-72x72.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="96x96"   href={`./icons/icon-96x96.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="144x144" href={`./icons/icon-144x144.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="192x192" href={`./icons/icon-192x192.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="256x256" href={`./icons/icon-256x256.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="384x384" href={`./icons/icon-384x384.png?v=${sha}`}/>
      <link rel="apple-touch-icon" sizes="512x512" href={`./icons/icon-512x512.png?v=${sha}`}/>
